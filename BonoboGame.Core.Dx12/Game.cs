...
using BonoboGame.Core.Dx12.Systems;
using BonoboGame.Core.Dx12.Extensions;
using BonoboGame.Core.Dx12.Components;
using BonoboGame.Core.Dx12.Serializers;

namespace BonoboGame.Core.Dx12
{
    ...
    public class Game : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (Keyboard.GetState().IsKeyDown(Keys.K))
            {
                ...
                var amount = System.Random.Shared.Next(0, 500);
            ...
            if (Keyboard.GetState().IsKeyDown(Keys.L))
            {
                ...
                var amount = System.Random.Shared.Next(0, System.Math.Min(500, entities.Length));
